...
class AnnotationSystem {
    constructor() {
        ...
        // 问卷元素 - 滑动条
        this.empathySliders = {
            concern: document.getElementsByName('concern')[0],
            expressiveness: document.getElementsByName('expressiveness')[0],
            emotional_resonance: document.getElementsByName('emotional_resonance')[0],
            warmth: document.getElementsByName('warmth')[0],
            attunement: document.getElementsByName('attunement')[0],
            cognitive_understanding: document.getElementsByName('cognitive_understanding')[0],
            understanding_feelings: document.getElementsByName('understanding_feelings')[0],
            acceptance: document.getElementsByName('acceptance')[0],
            responsiveness: document.getElementsByName('responsiveness')[0]
        };
    ...
    replayContextSegment() {
        ...
        this.currentTimeUpdateHandler = () => {
            if (this.contextVideo.currentTime >= endTime) {
                ...
                console.log(`Video stopped at end time: ${endTime}s`);
            }
        };
