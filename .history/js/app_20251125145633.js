        ...
        if (replaySegmentBtn) {
            replaySegmentBtn.addEventListener('click', () => {
                if (this.currentAnnotationPoint) {
                    ...
                    console.log(`重播片段: ${startTime} 到 ${endTime}`);
                    ...
                    const segmentEndHandler = () => {
                        if (this.videoPlayer.currentTime >= endTime) {
                            this.videoPlayer.pause();
                            this.videoPlayer.currentTime = startTime;
                            this.videoPlayer.removeEventListener('timeupdate', segmentEndHandler);
                            this.videoPlayer._segmentEndHandler = null;
                        }
                    };
                    
                    this.videoPlayer._segmentEndHandler = segmentEndHandler;
                    this.videoPlayer.addEventListener('timeupdate', segmentEndHandler);
                }
            });
        }
